...
'Порядок следования полей при просмотре
    CurrentDocFieldOrder = "DocID, DocIDParent, Author, UserFieldText1, UserFieldText2, UserFieldText3, UserFieldText4, UserFieldText5, UserFieldMoney1, ListToReconcile, NameAproval, ListToView, Department,  PartnerName, Content"
