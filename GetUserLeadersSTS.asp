...
'**********************************************
'SAY 2008-09-16 вычисляемые роли: Эпизод 3
...
Sub GetUserLeaders(pConnectString)
  ...
  ds.Open "select * from Users where WinLogin not like 'global\%'", Conn, 3, 1, &H1
'  ds.Open "select * from Users", Conn, 3, 1, &H1
  ...
  do while not ds.EOF
    ...
    Response.Write "<TD><FONT size=3 face=""courier new"">"+Replace(Replace(GetChiefNameUpperWithDepLevelSTS(ds("Department"), 3, ds("UserID")), ">", "&gt;"), "<", "&lt;")+".</FONT></TD>"
    Response.Write "<TD><FONT size=3 face=""courier new"">"+Replace(Replace(GetChiefNameUpperWithDepLevelSTS(ds("Department"), 2, ds("UserID")), ">", "&gt;"), "<", "&lt;")+".</FONT></TD>"
    Response.Write "<TD><FONT size=3 face=""courier new"">"+Replace(Replace(GetChiefNameUpperWithDepLevelSTS(ds("Department"), 1, ds("UserID")), ">", "&gt;"), "<", "&lt;")+".</FONT></TD>"
    Response.Write "</TR>"
	i = i + 1
    ds.MoveNext
  loop
